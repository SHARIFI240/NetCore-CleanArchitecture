...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _init: function (options, refreshMode) {
            ...
            if (!$h.isEmpty(self.msgPlaceholder)) {
                ...
                self.$caption.attr('placeholder', self.msgPlaceholder.replace('{files}', f).replace("انتخاب files...", "انتخاب فایل ..."));
            }
            ...
            self.fileManager = {
                ...
                remove: function ($thumb) {
                    ...
                    if (id) {
                        ...
                        //if (decodeURIComponent(id).toString().length > 0) {
                        //    DeleteAttachment(decodeURIComponent(id).toString().length);
                        //}
                    }
                },
        ...
        _initTemplateDefaults: function () {
            ...
            tCaption = '<div class="file-caption form-control {class}" tabindex="500">\n' +
                ...
                '  <input class="file-caption-name" placeholder="انتخاب فایل" onkeydown="return false;" onpaste="return false;">\n' +
                '</div>';
            //noinspection HtmlUnknownAttribute
            ...
            tActions = '<div class="file-actions">\n' +
                ...
                '<div class="clearfix"></div>';
            //noinspection HtmlUnknownAttribute
            tActionDelete = `<button onclick="DeleteAttachment(this)" type="button" class="kv-file-remove {removeClass}" title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n`;
            ...
            tAudio = '<!--suppress ALL --><audio class="kv-preview-data file-preview-audio" controls' + tStyle + '>\n<source src="{data}" ' +
                'type="{type}">\n' + $h.DEFAULT_PREVIEW + '\n</audio>\n';
            tFlash = '<iframe class="kv-preview-data file-preview-flash" src="{data}" type="application/x-shockwave-flash"' + tStyle + '></iframe>\n';
            tPdf = '<iframe class="kv-preview-data file-preview-pdf" src="{data}" type="application/pdf"' + tStyle + '></iframe>\n';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'btn btn-sm btn-kv btn-default btn-outline-primary',
                    removeErrorClass: 'btn btn-sm btn-kv btn-danger',
                    removeTitle: 'حذف فایل',
                    uploadIcon: '<i class="glyphicon glyphicon-upload"></i>',
                    uploadClass: 'btn btn-sm btn-kv btn-default btn-outline-primary',
                    uploadTitle: 'بارگذاری فایل',
                    uploadRetryIcon: '<i class="glyphicon glyphicon-repeat"></i>',
                    uploadRetryTitle: 'بارگذاری مجدد',
                    downloadIcon: '<i class="glyphicon glyphicon-download"></i>',
                    downloadClass: 'btn btn-sm btn-kv btn-default btn-outline-primary',
                    downloadTitle: 'بارگیری فایل',
                    zoomIcon: '<i class="glyphicon glyphicon-zoom-in"></i>',
                    zoomClass: 'btn btn-sm btn-kv btn-default btn-outline-primary',
                    zoomTitle: 'نمایش جزئیات',
                    ...
                    indicatorErrorTitle: 'خطای بارگذاری',
                    indicatorLoadingTitle: 'بارگذاری ...',
        ...
        _getMsgSelected: function (n) {
            ...
            return n > 0 ? self.msgSelected.replace('{n}', n).replace('{files}', strFiles).replace("files selected", "فایل انتخاب شده") : self.msgNoFilesSelected;
        },
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgNo: 'No',
        msgNoFilesSelected: 'هیچ فایل انتخاب نشده',
        ...
        msgUploadBegin: 'در حال مقدار دهی ...',
        msgUploadEnd: 'با موفقیت آپلود شد',
        ...
        dropZoneTitle: 'برای بارگذاری بکشید و رها کنید',
